...
EFFECTIVE_BACKEND_FIELDS: tuple[str, ...] = (
    ...
    "source_model_provenance_status",
    ...
    "rosetta_packstat",
    "derived_structure_status",
    "derived_structure_error",
    "derived_structure_cache_hit",
    "derived_structure_id",
    "derived_source_model_sha256",
    "derived_target_sequence_sha256",
    "derived_binder_sequence_sha256",
    "derived_interface_distance_cutoff",
